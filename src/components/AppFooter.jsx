  ...
  return (
    <div className='AppFooter' style={{ marginTop: 'auto', backgroundColor: '#EAF2F8', padding: '16px' }}>
      <div className='flex space-x-4'>
        <a
          href='https://twitter.com/Dmonier87'
          target='_blank'
        ...
        <a
          href='https://github.com/monier87'
          target='_blank'
          rel='noopener noreferrer'
          style={{ margin: '0 5px' }}
        >
        ...
        <a
          href='https://instagram.com/carlosdavid1905'
          target='_blank'
          rel='noopener noreferrer'
          style={{ margin: '0 5px' }}
        >
        ...
        <a
          href='https://linkedin.com/in/carlos-monier-712948185'
          target='_blank'
          rel='noopener noreferrer'
          style={{ margin: '0 5px' }}
        >
